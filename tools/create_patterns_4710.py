...
os.chdir(sys.path[0])# ʹ���ļ�����Ŀ¼
PI = 3.1415926
filename = "pattern_4710.csv"

if not os.path.exists('patterns_4710'):os.makedirs('patterns_4710')
...
with open(filename) as f:
    ...
    for row in reader:
        ...
        if "vertical" == direct:
            ...
            cv2.imwrite('patterns_4710/%02d_x.bmp' % n, img_x)
            n += 1
            print(n)
            ...
            cv2.imwrite('patterns_4710/%02d_y.bmp' % n, img_y)
            n += 1
            print(n)
    ...
    for pixel in [255, 200, 150, 100, 50, 0]:
            ...
            for y_ in range(1080):
                for x_ in range(1920):
                    img_p[y_, x_, :] = pixel
            cv2.imwrite('patterns_4710/%02d_p.bmp' % n, img_p)
            n += 1
            print(n)
