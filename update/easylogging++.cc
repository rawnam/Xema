...
void Configurations::setToDefault(void) {
  ...
  setGlobally(ConfigurationType::MaxLogFileSize, std::string("10485760"), true);
...
void Configurations::setRemainingToDefault(void) {
  ...
  unsafeSetIfNotExist(Level::Global, ConfigurationType::MaxLogFileSize, std::string("10485760"));
